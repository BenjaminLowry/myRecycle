...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func saveData() {
        ...
        archiver.encode(currentAppStatus.loggedInUser, forKey: "Logged In User")
        ...
        for index in currentAppStatus.localAccounts {
            ...
            PFUser.current()?.setObject(index.profilePicture, forKey: "Profile Picture")
            ...
            user.saveInBackground { (succeeded, error) -> Void in
                if succeeded {
